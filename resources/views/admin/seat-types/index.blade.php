...
@section('content')
    ...
    <x-admin.search-filter searchPlaceholder="Tìm theo tên loại ghế..." :filters="[]" :sortOptions="[
        'name' => 'Tên loại ghế',
        'surcharge' => 'Phụ phí',
        'created_at' => 'Ngày tạo',
    ]" />
                        ...
                        <tbody>
                            @foreach ($seatTypes as $seatType)
                                <tr>
                                    ...
                                    <td>
                                        <span
                                            class="badge bg-{{ $seatType->surcharge > 0 ? 'warning' : 'secondary' }} {{ $seatType->surcharge > 0 ? 'text-dark' : 'text-white' }}">
