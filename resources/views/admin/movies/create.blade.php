                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select @error('age_rating') is-invalid @enderror"
                                ...
                                name="age_rating"
                                required>
                                <option value="P" {{ old('age_rating') == 'P' ? 'selected' : '' }}>P - Phổ biến</option>
                                <option value="C13" {{ old('age_rating') == 'C13' ? 'selected' : '' }}>C13 - Trên 13 tuổi</option>
                                <option value="C16" {{ old('age_rating') == 'C16' ? 'selected' : '' }}>C16 - Trên 16 tuổi</option>
                                <option value="C18" {{ old('age_rating') == 'C18' ? 'selected' : '' }}>C18 - Trên 18 tuổi</option>
                            </select>
                            @error('age_rating')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
