...
@section('content')
    ...
    <x-admin.search-filter searchPlaceholder="Tìm theo tên phim, mô tả..." :filters="[
        [
            'name' => 'status',
            'label' => 'Trạng thái',
            'col' => 2,
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group btn-group-sm">
                                        <a href="{{ route('admin.movies.edit', $movie) }}" class="btn btn-outline-primary"
                                            title="Sửa">
                                            <i class="bi bi-pencil"></i>
                                        </a>
                                        <form action="{{ route('admin.movies.destroy', $movie) }}" method="POST"
                                            class="d-inline" onsubmit="return confirm('Bạn có chắc muốn xóa phim này?')">
                                            @csrf
                                            @method('DELETE')
