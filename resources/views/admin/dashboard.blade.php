    ...
    <div class="col-md-3">
        <div class="card bg-warning text-dark shadow-sm">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="text-uppercase mb-1">Diễn viên</h6>
                        <h2 class="mb-0">{{ \App\Models\Actor::count() }}</h2>
                    </div>
                    <div class="fs-1">
            ...
            <div class="card-footer bg-warning bg-opacity-75 border-0">
                <a href="{{ route('admin.actors.index') }}" class="text-dark text-decoration-none small">
                    Xem chi tiết <i class="bi bi-arrow-right"></i>
                </a>
            </div>
        </div>
                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge bg-{{ $movie->status == 'now_showing' ? 'success' : 'warning' }}">
